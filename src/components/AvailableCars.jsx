      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
           {data?.vehicles?.map((vehicle) => ( 
            <div key={vehicle.id} className="group bg-slate-900/40 rounded-[2.5rem] overflow-hidden border border-slate-800 transition-all duration-500 hover:border-blue-500/30 hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] hover:-translate-y-2">
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="text-right">
                    <p className="text-slate-500 text-[10px] uppercase font-bold tracking-widest mb-1">Current Price</p>
                    <p className="text-2xl font-black text-white leading-none tracking-tight">{vehicle.price}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 py-6 border-y border-slate-800/60 mb-8">
                  <div className="flex flex-col items-center gap-2 border-r border-slate-800/60">
                    ...
                    <span className="text-[11px] font-bold text-slate-300 uppercase tracking-tighter">{vehicle?.milage}</span>
                  </div>
