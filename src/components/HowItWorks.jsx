...
const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      icon: <FaCarSide size={32} className="text-blue-500" />,
    },
    {
      id: "03",
    ...
    },
    {
      ...
      icon: <MdSecurity size={36} className="text-blue-500" />,
    },
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <h3 className="text-4xl md:text-6xl font-extrabold mb-6 tracking-tight">
            How to Win Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">Next Ride</span>
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 relative">
          ...
          {steps.map((step, index) => (
            <div 
              key={index} 
              className="group relative bg-slate-900/40 border border-slate-800/60 p-10 rounded-3xl hover:border-blue-500/40 transition-all duration-500 z-10 backdrop-blur-md"
            >
              ...
              {/* Icon Container */}
              <div className="w-20 h-20 bg-slate-800/50 rounded-2xl flex items-center justify-center mb-8 border border-slate-700/50 group-hover:scale-110 group-hover:bg-blue-600/10 group-hover:border-blue-500/30 transition-all duration-500 shadow-xl">
                {step.icon}
              </div>

              {/* Text Content */}
              <h4 className="text-2xl font-bold mb-4 group-hover:text-blue-400 transition-colors duration-300">
                {step.title}
              </h4>
              ...
              <div className="absolute bottom-0 left-0 h-1.5 w-0 bg-gradient-to-r from-blue-600 to-cyan-400 transition-all duration-700 group-hover:w-full rounded-b-3xl shadow-[0_5px_15px_rgba(37,99,235,0.4)]" />
            </div>
          ))}
        </div>
        ...
        <div className="mt-20 text-center">
          <button className="relative inline-flex items-center justify-center px-10 py-4 overflow-hidden font-bold text-white transition duration-300 ease-out border-2 border-blue-600 rounded-full shadow-md group">
            <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-blue-600 group-hover:translate-x-0 ease">
              <FaCarSide size={20} className="mr-2" />
              Let's Go
            </span>
            <span className="absolute flex items-center justify-center w-full h-full text-blue-500 transition-all duration-300 transform group-hover:translate-x-full ease">Start Bidding</span>
